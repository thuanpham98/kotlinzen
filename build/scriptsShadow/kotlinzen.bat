...
set CLASSPATH=%APP_HOME%\lib\kotlinzen-1.0.0-SNAPSHOT-fat.jar

@rem Execute kotlinzen
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %KOTLINZEN_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%KOTLINZEN_EXIT_CONSOLE%" exit 1
exit /b 1
